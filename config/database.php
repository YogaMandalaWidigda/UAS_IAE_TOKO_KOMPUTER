...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'database' => env('DB_DATABASE_PAYMENT', 'db_laravel_payments'),
 ...
 'shipment' => [
    'driver' => env('DB_SHIPMENT_CONNECTION', 'mysql'),
    'host' => env('DB_SHIPMENT_HOST', '127.0.0.1'),
    'port' => env('DB_SHIPMENT_PORT', '3306'),
    'database' => env('DB_SHIPMENT_DATABASE', 'db_laravel_shipment'),
    'username' => env('DB_SHIPMENT_USERNAME', 'root'),
    'password' => env('DB_SHIPMENT_PASSWORD', ''),
    'charset' => 'utf8mb4',
    'collation' => 'utf8mb4_unicode_ci',
    'prefix' => '',
    'strict' => true,
